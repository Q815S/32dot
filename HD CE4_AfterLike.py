...
canvas.create_rectangle(0, 0, canvas_width, canvas_height, fill='#DBDBE6', width=0)

text_label = tk.Label(canvas, text=f'축하합니다! 점수는 {similarity_percentage:.2f}점입니다.\n\n체험이 끝났습니다.\n스태프의 안내에 따라 자리에 앉아주세요.', font=("LG Smart UI Mobile Regular", 40), bg='#DBDBE6')
